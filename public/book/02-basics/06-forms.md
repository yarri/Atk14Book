...
Pokud si nevystačíš s fieldy a widgety, které jsou součástí ATK14, můžeš si napsat vlastní nebo je nainstalovat jako balíček pomocí _Composer_ (např. [PhoneField](https://packagist.org/packages/atk14/phone-field) nebo [RecaptchaField](https://packagist.org/packages/atk14/recaptcha-field)).

Teď si prohlédni typický formulář pro registraci uživatele. Jednotlivá políčka formuláře jsou určena v metodě *set_up()*. Vidíš, že i formulář může mít svou validační metodu _clean()_, ve které se obvykle řeší vztahy mezi políčky.
...
Podívej se, jak vypadá celý UsersController. Metoda _validate()_ vrací pole vyčištěných dat. Pokud by byla byť jen jedna hodnota špatně, bude vrácen NULL.
...
O zobrazení formuláře se postará helper *{form}* a dvě sdílené šablonky. Podívej se.
...
Vyzkoušej si tuto registraci uživatele v provozu na adrese <http://www.atk14.net/en/users/create_new/>
